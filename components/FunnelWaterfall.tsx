          ...
          >
            ...
            {ticks.map((t) => (
              <g key={t}>
                ...
                {/* En un teléfono la tarjeta se reduce a menos de la mitad y
                    estos números quedan en cuatro píxeles, ilegibles. Las
                    cifras grandes de arriba ya dicen el valor de cada columna. */}
                {escala > 0.75 && (
